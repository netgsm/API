...
public class SOAPServisiSmsGondermeNN {
    /**
     * NETGSM
     * SOAP ile SMS gönderme N:N
     * Örneği
     * */
    public static void main(String[] args) {
        ...
        msg.add("yeni mesaj 1");
        msg.add("yeni mesaj 2");
        // msg.add("mesaj");
        // ............
        ...
        donen_deger = port.smsGonderNNV2(username, password, header, msg, gsm, encoding, startDate, stopDate, bayiKodu, filter);
